...
* add sast tasks ([#1787](https://github.com/jjaquish/insights-rbac-ui/issues/1787)) ([9442e25](https://github.com/jjaquish/insights-rbac-ui/commit/9442e2568bbd2536885bfbc4e71a7c9cb772a3ab))
* **addGroup:** incorporate pf6 to branch ([3c1436a](https://github.com/jjaquish/insights-rbac-ui/commit/3c1436a48f1750170a2a2065c595be5b18e30105))
* **AddGroupMembers:** restored filtering capabilities ([0ba659a](https://github.com/jjaquish/insights-rbac-ui/commit/0ba659a6a5c8f7f3120cdc13716340bb62da6987))
* **AddGroupWizard:** ensure service accounts are properly added ([6393cd6](https://github.com/jjaquish/insights-rbac-ui/commit/6393cd650b7a03eba4aaa2f34962e5ac224b9ff2))
* **AddGroupWizard:** fix lint ([61fd6e3](https://github.com/jjaquish/insights-rbac-ui/commit/61fd6e3b75a19ab82168bbece5e5b436df12c0aa))
* address console.warns ([c6d342d](https://github.com/jjaquish/insights-rbac-ui/commit/c6d342d3ab2cc9a328294964b68bfcc479853755))
* address skipped Storybook tests ([8d84829](https://github.com/jjaquish/insights-rbac-ui/commit/8d848294883b95a8fb9324c0524a84496391e4b6))
* **admin-group:** when we don't have admin group do not break ([#1765](https://github.com/jjaquish/insights-rbac-ui/issues/1765)) ([881e1da](https://github.com/jjaquish/insights-rbac-ui/commit/881e1dad988d8e624a7eb4f245ffa1e2b1a5cd66))
* allow users to see the full list of permissions for their own profile ([#1858](https://github.com/jjaquish/insights-rbac-ui/issues/1858)) ([0d0d4de](https://github.com/jjaquish/insights-rbac-ui/commit/0d0d4de06a05e54e5cca1b6597b176b9ff669bd1))
* **api-arg:** js clients has broken arguments so we have to use list of args ([#1844](https://github.com/jjaquish/insights-rbac-ui/issues/1844)) ([e3f2d4a](https://github.com/jjaquish/insights-rbac-ui/commit/e3f2d4a02b78c869bd1dab30048f9f4e4402881d))
* **Axios:** update request to use correct params ([ba338ba](https://github.com/jjaquish/insights-rbac-ui/commit/ba338ba59cd8fa194f7dd17ae2073b6cb2a17d21))
* **basename:** basename for workspaces is calculated incorrectly ([#1699](https://github.com/jjaquish/insights-rbac-ui/issues/1699)) ([113a38e](https://github.com/jjaquish/insights-rbac-ui/commit/113a38e4d3475e79252a0e931c203056d6e77359))
* **bug:** fix circular structure error in user activation toggle ([3b3f983](https://github.com/jjaquish/insights-rbac-ui/commit/3b3f9836f2898fe8be6e3ad7d5dcb2a33bf065aa))
* changes to role table filtering to prevent strange behavior ([48febbf](https://github.com/jjaquish/insights-rbac-ui/commit/48febbf8eb6cbe242dd30be9008ee85bec2373ba))
* chromatic workflow ([d4e1b8b](https://github.com/jjaquish/insights-rbac-ui/commit/d4e1b8b5c3a0e4f56ec6cbf7b655fa6e3fb6b923))
* **common-auth:** current user cannot be disabled ([#1852](https://github.com/jjaquish/insights-rbac-ui/issues/1852)) ([e1af3a1](https://github.com/jjaquish/insights-rbac-ui/commit/e1af3a1ea7f8fdcec8eab9dca79080742d2a53c9))
* **common-auth:** org admins in users table ([#1774](https://github.com/jjaquish/insights-rbac-ui/issues/1774)) ([32997a0](https://github.com/jjaquish/insights-rbac-ui/commit/32997a0b3e37aa0f925c4877ba3030c0247aa77d))
* **common-auth:** remove invite message ([#1789](https://github.com/jjaquish/insights-rbac-ui/issues/1789)) ([5d808c5](https://github.com/jjaquish/insights-rbac-ui/commit/5d808c5ba27458798fda0cb081a9c70b5ec7676b))
* **common-auth:** use org ID ([#1757](https://github.com/jjaquish/insights-rbac-ui/issues/1757)) ([5ecb079](https://github.com/jjaquish/insights-rbac-ui/commit/5ecb079d46538f74c10a0ad0848ab533bf0b6695))
* **console:** address all warnings and errors ([6ba7480](https://github.com/jjaquish/insights-rbac-ui/commit/6ba74806fd4150c3201c9cddb96604efeabdc1fb))
* correct move workspace notification message variables ([3b2af5b](https://github.com/jjaquish/insights-rbac-ui/commit/3b2af5b5bd08300bbb7d72bcd0f85e93bf698bf1))
* correctly render the Time created column for the service accounts ([25c830d](https://github.com/jjaquish/insights-rbac-ui/commit/25c830d1fb586d504feac0c24f766bb947db67fa))
* **cost-settings:** do not send resource definitions ([#1929](https://github.com/jjaquish/insights-rbac-ui/issues/1929)) ([0e5727c](https://github.com/jjaquish/insights-rbac-ui/commit/0e5727c85a38d2cfe0c70f843b0368ddcec07e09))
* crashes when running the app in dev mode ([f0a9942](https://github.com/jjaquish/insights-rbac-ui/commit/f0a994236eff2af3d1ce6fa01cd02691f4592e37))
* **create-workspace:** workspace selector can be enabled if hierarchy FF is on ([#1876](https://github.com/jjaquish/insights-rbac-ui/issues/1876)) ([baef26c](https://github.com/jjaquish/insights-rbac-ui/commit/baef26c680ab99a1ee295e279c3c4b8603ed31a6))
* **CreateGroupWizard:** display user friendly error messages ([9ffdc9d](https://github.com/jjaquish/insights-rbac-ui/commit/9ffdc9d1191eada8b48ce4f5e7ecc7e3fe1e138e))
* **CreateGroupWizard:** extend tests to verify service accounts creation ([d422ada](https://github.com/jjaquish/insights-rbac-ui/commit/d422adaa345b0656d96c918df62741533238a7aa))
* **cypress:** failing tests ([#1835](https://github.com/jjaquish/insights-rbac-ui/issues/1835)) ([5c4bef8](https://github.com/jjaquish/insights-rbac-ui/commit/5c4bef8f5a085bb6a928dbf33ef48c653573ff53))
* **debounce:** resolve flaky test and consolidate utilities ([e1b2cce](https://github.com/jjaquish/insights-rbac-ui/commit/e1b2cce0383e5594edbda1bc246c7695078f5ed6))
* **delete-ws:** fix delete workspace by styling it and properly sending request ([#1817](https://github.com/jjaquish/insights-rbac-ui/issues/1817)) ([b8b6d13](https://github.com/jjaquish/insights-rbac-ui/commit/b8b6d1311d6832994e3f56373b96a7b25ccf7a1d))
* **dependabot:** disable dependabot for weekly npm updates ([#1811](https://github.com/jjaquish/insights-rbac-ui/issues/1811)) ([e55e7ee](https://github.com/jjaquish/insights-rbac-ui/commit/e55e7ee237856e7c5202872de9a760d477b650e6))
* **deploy:** correct quay repository in frontend config ([#1693](https://github.com/jjaquish/insights-rbac-ui/issues/1693)) ([1f433e9](https://github.com/jjaquish/insights-rbac-ui/commit/1f433e927df2f3febc5301cedb775bdbea21caa8))
* **deploy:** correct quay repository in frontend config ([#1693](https://github.com/jjaquish/insights-rbac-ui/issues/1693)) ([800fbb7](https://github.com/jjaquish/insights-rbac-ui/commit/800fbb7bf3efec362ac3f08e7a690b3982f2b4c3))
* **deps:** bump tmp and inquirer ([#1915](https://github.com/jjaquish/insights-rbac-ui/issues/1915)) ([5484280](https://github.com/jjaquish/insights-rbac-ui/commit/5484280bc43c435c941283b1b5b8eee322c0f608))
* **deps:** update babel monorepo ([#1971](https://github.com/jjaquish/insights-rbac-ui/issues/1971)) ([b28803a](https://github.com/jjaquish/insights-rbac-ui/commit/b28803a8d9f7d90589b975d2fbd550ae889c2a23))
* **deps:** update babel monorepo to v7.28.5 ([24b371e](https://github.com/jjaquish/insights-rbac-ui/commit/24b371efc9ff6fb507173a9e7da1b38ad7dab97b))
* **deps:** update babel monorepo to v7.28.6 ([6033474](https://github.com/jjaquish/insights-rbac-ui/commit/60334740fa85eb8f9460da8373df5019f18f5a5b))
* **deps:** update dependency @formatjs/cli to v6.8.8 ([e1a60ad](https://github.com/jjaquish/insights-rbac-ui/commit/e1a60ad95565a71bcda7a56f3e31b35d53b4a2d6))
* **deps:** update dependency @redhat-cloud-services/frontend-components-utilities to v7.0.20 ([343cc09](https://github.com/jjaquish/insights-rbac-ui/commit/343cc09714dc88fe8e380cef9f39bed95e220e24))
* **deps:** update dependency @redhat-cloud-services/host-inventory-client to v4.1.7 ([f84a6e0](https://github.com/jjaquish/insights-rbac-ui/commit/f84a6e08e7ca97fd8a4f7e3ac77594026ad82a90))
* **deps:** update dependency react-router-dom to v6.30.2 ([dd8fdd5](https://github.com/jjaquish/insights-rbac-ui/commit/dd8fdd57b7cde1f2108dafe3d7fd6ec85f140e6c))
* **disable-users:** use user ID instead of user UUID ([#1927](https://github.com/jjaquish/insights-rbac-ui/issues/1927)) ([afefa4c](https://github.com/jjaquish/insights-rbac-ui/commit/afefa4c3b2d91382f25b294ca25f77172c48c185))
* do not checkout the repo from the GH cache action ([a7ee1fd](https://github.com/jjaquish/insights-rbac-ui/commit/a7ee1fdb25e777cd21e5ffd2bfd468690554e10b))
* **feo:** removing ciam app data ([#1910](https://github.com/jjaquish/insights-rbac-ui/issues/1910)) ([5f5e609](https://github.com/jjaquish/insights-rbac-ui/commit/5f5e609b640502b2d2fd71a1f2eb0d635bc1d193))
* fetch all workspaces by default ([#1846](https://github.com/jjaquish/insights-rbac-ui/issues/1846)) ([7def691](https://github.com/jjaquish/insights-rbac-ui/commit/7def6910925a270d43604b92148ad12e46a470a4))
* fix broken cypress tests ([f8a88d0](https://github.com/jjaquish/insights-rbac-ui/commit/f8a88d0231b951ea4471af6c2f308dfc78ed4484))
* fix OOM on CI ([d835a6a](https://github.com/jjaquish/insights-rbac-ui/commit/d835a6ae3e1231ab6b181eba5062f4054332a976))
* fix swc error on CI ([b6e0493](https://github.com/jjaquish/insights-rbac-ui/commit/b6e04934470d4b8eb534d9be3be8085af3d6c641))
* fix typo and update snapshots ([67923e9](https://github.com/jjaquish/insights-rbac-ui/commit/67923e98223249eed39edcb5b4158d1a2d025d81))
* fix users-and-user-groups E2E ([14dcf89](https://github.com/jjaquish/insights-rbac-ui/commit/14dcf89a4ca61c4ae99255c328a62d74bc046b88))
* fixed bug with filters in permissions table of create role wizard ([6daa692](https://github.com/jjaquish/insights-rbac-ui/commit/6daa692cb778275158dae36a17a58550cdb51b4f))
* flag the selected group as not a plat default after a change ([559c3eb](https://github.com/jjaquish/insights-rbac-ui/commit/559c3ebffb0812394f0982c52ffaef48415ac062))
* flaky AddGroupMembers WithFiltering test ([7b152aa](https://github.com/jjaquish/insights-rbac-ui/commit/7b152aa4705453abc24d23a49eafd65693196996))
* **grantaccesswizard:** internationalize wizard labels ([fbcba6f](https://github.com/jjaquish/insights-rbac-ui/commit/fbcba6f5141aa61295d2c456e0502375601c29f2))
* **GrantAccessWizard:** update branch ([7eb8903](https://github.com/jjaquish/insights-rbac-ui/commit/7eb8903fe4d0bd40d72c9d2e27b16455334959a9))
* **GrantAccessWizard:** update roles step description ([728b9da](https://github.com/jjaquish/insights-rbac-ui/commit/728b9da8dd49504196241d187444ea386734d751))
* **groups:** adding and removing users from group ([#1907](https://github.com/jjaquish/insights-rbac-ui/issues/1907)) ([2e66610](https://github.com/jjaquish/insights-rbac-ui/commit/2e66610b5cdd43d78cdf8e15afb7f51d6f084411))
* **Groups:** restore warning dialog when changing Default Group ([3222086](https://github.com/jjaquish/insights-rbac-ui/commit/3222086924ffbd07bdddfcd35820271c0a35f993))
* handle case of undefined group ([#1782](https://github.com/jjaquish/insights-rbac-ui/issues/1782)) ([f4021f1](https://github.com/jjaquish/insights-rbac-ui/commit/f4021f170d990aa07f375e4527f929becfccaaa2))
* handle empty responses from Akamai for the potentially optional cost API ([#1834](https://github.com/jjaquish/insights-rbac-ui/issues/1834)) ([4f6afcf](https://github.com/jjaquish/insights-rbac-ui/commit/4f6afcf45482597a8fdbe57c9a4a8cc2881db3d1))
* hide service accounts table for default admin access ([#1709](https://github.com/jjaquish/insights-rbac-ui/issues/1709)) ([1452179](https://github.com/jjaquish/insights-rbac-ui/commit/1452179da1a55c17c486aed55d23e3a1a7e48285))
* inventory API integration and add filtering tests ([a8f8edf](https://github.com/jjaquish/insights-rbac-ui/commit/a8f8edf13487f65eead76cf7f22ff798098a5e5f))
* **invite:** by adding locale ([#1759](https://github.com/jjaquish/insights-rbac-ui/issues/1759)) ([c11e179](https://github.com/jjaquish/insights-rbac-ui/commit/c11e179995b5476b5a8730c80bb1866a20aaa8ba))
* issues with merge commit ([84917d3](https://github.com/jjaquish/insights-rbac-ui/commit/84917d3caab81a7970f80f148d3f9252582eb746))
* **itless:** fix itless users activate dropdown ([#1856](https://github.com/jjaquish/insights-rbac-ui/issues/1856)) ([43b26dc](https://github.com/jjaquish/insights-rbac-ui/commit/43b26dc9d3d6523e660a4d6022ce764a966b4d06))
* key prop spreading error ([25340d6](https://github.com/jjaquish/insights-rbac-ui/commit/25340d65cae9fb0835aea40d2359f15747c59899))
* **konflux:** add rpms check to pull requests ([#1691](https://github.com/jjaquish/insights-rbac-ui/issues/1691)) ([81d51ff](https://github.com/jjaquish/insights-rbac-ui/commit/81d51fffbabaf08a4fa3a7461d0bba31407d892d))
* **konflux:** add rpms check to pull requests ([#1691](https://github.com/jjaquish/insights-rbac-ui/issues/1691)) ([981c7ce](https://github.com/jjaquish/insights-rbac-ui/commit/981c7ceae4bc46143f703f666484e2cea4338469))
* **konflux:** failing konflux build by removing JAVA references ([#1743](https://github.com/jjaquish/insights-rbac-ui/issues/1743)) ([76bc417](https://github.com/jjaquish/insights-rbac-ui/commit/76bc4171ac08ab2ecbae61b52634ce868c7d2c97))
* **konflux:** remove duplicate name of task ([#1723](https://github.com/jjaquish/insights-rbac-ui/issues/1723)) ([991729a](https://github.com/jjaquish/insights-rbac-ui/commit/991729a25b0121bda9802c762cb707e3a4757aa2))
* **konflux:** remove sbom json check ([#1722](https://github.com/jjaquish/insights-rbac-ui/issues/1722)) ([9fe1bce](https://github.com/jjaquish/insights-rbac-ui/commit/9fe1bcefd693fa180631164c10c9bd28f51d91d3))
* **konflux:** update buildah image sha ([#1719](https://github.com/jjaquish/insights-rbac-ui/issues/1719)) ([7d637b8](https://github.com/jjaquish/insights-rbac-ui/commit/7d637b801e731a7f5a88fb97e4d9062b18412d7c))
* **konflux:** update oci-ta and rpms scan image dependencies ([#1720](https://github.com/jjaquish/insights-rbac-ui/issues/1720)) ([1b2cf81](https://github.com/jjaquish/insights-rbac-ui/commit/1b2cf8171fb64ce0f3417335dbfda54b4e988973))
* lint ([516279f](https://github.com/jjaquish/insights-rbac-ui/commit/516279f3aa346dcd01d8a66cd3aa0aa15a77f04b))
* lint issues in ProductionOrgAdmin ([dcc41cd](https://github.com/jjaquish/insights-rbac-ui/commit/dcc41cd7658a8b4ad11a2887ac324ee10eb0ad40))
* **lint:** remove import ([f4baac8](https://github.com/jjaquish/insights-rbac-ui/commit/f4baac8f97bb477b859a9f1959b8c34020b81fa0))
* localize name filter strings ([0832973](https://github.com/jjaquish/insights-rbac-ui/commit/0832973c09fe7962a3c09c638510fefb9b3b2f8c))
* made updates based on sourcery-ai comments ([aaa45f9](https://github.com/jjaquish/insights-rbac-ui/commit/aaa45f9eff0c445d5c9e86438acb6fdf7e008a8c))
* made updates based on sourcery-ai comments ([2e49568](https://github.com/jjaquish/insights-rbac-ui/commit/2e49568b1991a9dd28b44437a72bfee82f6030ab))
* **many:** clear filters now working across the board ([1ab8e2b](https://github.com/jjaquish/insights-rbac-ui/commit/1ab8e2b4daaf729e686ff48cdb83e63a4268958f))
* memoize users row data ([60deb9b](https://github.com/jjaquish/insights-rbac-ui/commit/60deb9b76285d3b6899ebe59d8d849f92ae9a384))
* more lint ([3d3d870](https://github.com/jjaquish/insights-rbac-ui/commit/3d3d87006b0a6ffefb2bc1ac7ee3765b52f8740a))
* **nav:** change pathname ([#2106](https://github.com/jjaquish/insights-rbac-ui/issues/2106)) ([7f5002f](https://github.com/jjaquish/insights-rbac-ui/commit/7f5002f866b27b3c73e9d3984ec3fd20b237fd5c))
* **navigation:** remove explicit bundleSegment for service-accounts and learning resources ([#2096](https://github.com/jjaquish/insights-rbac-ui/issues/2096)) ([79e16bf](https://github.com/jjaquish/insights-rbac-ui/commit/79e16bfe54689d48993996c6208c0d2fbcac6b09))
* **navigation:** remove redundant service-accounts entry ([426b24a](https://github.com/jjaquish/insights-rbac-ui/commit/426b24a365289edac2235991c4199828b7d25239))
* **org admin:** marking user org admin with correct ID ([#1756](https://github.com/jjaquish/insights-rbac-ui/issues/1756)) ([31606bb](https://github.com/jjaquish/insights-rbac-ui/commit/31606bb17750cb2bbcbd2d84a85b7ea7aa60d0fa))
* **permissions:** view WS list for users with groups read ([#1821](https://github.com/jjaquish/insights-rbac-ui/issues/1821)) ([9bc20af](https://github.com/jjaquish/insights-rbac-ui/commit/9bc20afd7ed7868dea79df7e7366dd0073bf0d9a))
* **permission:** unable to load more than 2 pages in permissions ([#1688](https://github.com/jjaquish/insights-rbac-ui/issues/1688)) ([f150391](https://github.com/jjaquish/insights-rbac-ui/commit/f150391edead6b54b4c8255706024a1f09126f49))
* **permission:** unable to load more than 2 pages in permissions ([#1688](https://github.com/jjaquish/insights-rbac-ui/issues/1688)) ([2d08c25](https://github.com/jjaquish/insights-rbac-ui/commit/2d08c25204ab35488a01c1c05cb51c942f244510))
* prevent 'Add role to this group' link showing for admin group during loading ([756eb0d](https://github.com/jjaquish/insights-rbac-ui/commit/756eb0d009adf24e0837d9f4f0bd067375c9039f))
* prevent unauthorized API calls causing error toast spam for non-admin users ([55e0ddc](https://github.com/jjaquish/insights-rbac-ui/commit/55e0ddc662ce6069c40624c81cc2bcdff8235d16))
* **productionOrgAdmin:** fix lint ([7088cb2](https://github.com/jjaquish/insights-rbac-ui/commit/7088cb29c1f8deed41dae4d497e7fd05201ccd29))
* **release:** fix release ([04b5593](https://github.com/jjaquish/insights-rbac-ui/commit/04b55936a99c38324af6458877da86265185b2eb))
* remove delay(300) before table render in sorting test ([c4fb616](https://github.com/jjaquish/insights-rbac-ui/commit/c4fb616780b3501f5d8b0dc296e50bfd6ba67070))
* remove legacy role components and fix Storybook test selectors ([73b302f](https://github.com/jjaquish/insights-rbac-ui/commit/73b302fd5aa5551c623e80c3ebb11b948c94488b))
* remove mapStateToProps and mapDispatchToProps ([d9179d6](https://github.com/jjaquish/insights-rbac-ui/commit/d9179d636346c3cbb00401820254ed00ff88de41))
* remove openshift asset from WS details ([#1890](https://github.com/jjaquish/insights-rbac-ui/issues/1890)) ([8a742fe](https://github.com/jjaquish/insights-rbac-ui/commit/8a742fe409a6890ea60355c49a25e3d7f3554e69))
* remove redundant User Jest test (covered by 15 Storybook tests) ([e2fcf0e](https://github.com/jjaquish/insights-rbac-ui/commit/e2fcf0e504e8b6f1f4470f6c49561ec5e2a34384))
* remove unused @redhat-cloud-services/cost-management-client and update axios to 1.12.0 ([88a42e9](https://github.com/jjaquish/insights-rbac-ui/commit/88a42e9e3c402c10386b036ce856a72ee22d638e))
* remove withRouter decorators ([5b17ed2](https://github.com/jjaquish/insights-rbac-ui/commit/5b17ed29b8a56abd124257d11d62b033c930e45c))
* rename groups.scss to Groups.scss for case sensitivity ([f003895](https://github.com/jjaquish/insights-rbac-ui/commit/f003895d37c4adecaabbbbc48bf0cc19a0b24189))
* replace useRouteMatch with useParams ([d23a2a2](https://github.com/jjaquish/insights-rbac-ui/commit/d23a2a25469e821d41ac14bb70b396f43402db53))
* resolve merge ([5a8c3b4](https://github.com/jjaquish/insights-rbac-ui/commit/5a8c3b4d43c55a558b9b7fa6bcbceaa041c8aff2))
* resource definition editing and wizard modal button layout ([5fce50e](https://github.com/jjaquish/insights-rbac-ui/commit/5fce50e5921ea443b03f8897b33244abfc26b1a6))
* **RHCLOUD-41224:** correct IAM learning resources link and text ([#1948](https://github.com/jjaquish/insights-rbac-ui/issues/1948)) ([e4fe13a](https://github.com/jjaquish/insights-rbac-ui/commit/e4fe13ad6627ff47ae94b9af13b36fbb48c782a8))
* **RHCLOUD-42361:** correct 'Learn more about workspaces' link URL ([#1949](https://github.com/jjaquish/insights-rbac-ui/issues/1949)) ([bda6768](https://github.com/jjaquish/insights-rbac-ui/commit/bda676892bbcf2d24a8dde0961c760bd56561649))
* **role wizard:** unflip workspace flag ([9807831](https://github.com/jjaquish/insights-rbac-ui/commit/9807831ab82e75ab12e29b14fc688124a53b6931))
* **RoleResourceDefinitions:** optimize selectors to prevent re-renders ([5a78f48](https://github.com/jjaquish/insights-rbac-ui/commit/5a78f48da77e7b9d36348868effade73fdc6dfcb))
* **roles:** align filtering + resource definition UX ([#2021](https://github.com/jjaquish/insights-rbac-ui/issues/2021)) ([3bfa514](https://github.com/jjaquish/insights-rbac-ui/commit/3bfa5149f280bb8a730f44ee5c8d48f40802ea6d))
* **rolesdrawer:** replace a tag with applink ([b80e6e8](https://github.com/jjaquish/insights-rbac-ui/commit/b80e6e8783a74a5761d805e988d48b524fb6f54b))
* **Roles:** fix nav for editing roles ([66ebd75](https://github.com/jjaquish/insights-rbac-ui/commit/66ebd758eb6088ba2a98c3f4e49452600cb8cfca))
* **roles:** when navigating from my user access ([#1904](https://github.com/jjaquish/insights-rbac-ui/issues/1904)) ([2b6af9b](https://github.com/jjaquish/insights-rbac-ui/commit/2b6af9bf0b8c8128a40ef4b77f4b848fe63a6d49))
* **rolewizard:** clean up some types ([023f76d](https://github.com/jjaquish/insights-rbac-ui/commit/023f76d068e5f20161e6bfe9b7c9a4ddd502a803))
* **rolewizard:** convert add role wizard to typescript ([a7b627b](https://github.com/jjaquish/insights-rbac-ui/commit/a7b627b3e918242f1ea9c0f8594cb6747927b424))
* **rolewizard:** delete js version of wizard context ([632004d](https://github.com/jjaquish/insights-rbac-ui/commit/632004df20177f69030427a693bf26c241b88657))
* run npx playwright install before running the tests for PRs ([c20a44a](https://github.com/jjaquish/insights-rbac-ui/commit/c20a44aa65171b8984b5d4e5a2134e01d266a60e))
* **service-accounts:** assign, list and delete from group ([#1901](https://github.com/jjaquish/insights-rbac-ui/issues/1901)) ([727a976](https://github.com/jjaquish/insights-rbac-ui/commit/727a976eeea501dccb022cac23c51b26276619ce))
* **serviceaccountslist:** make table compact ([c139d17](https://github.com/jjaquish/insights-rbac-ui/commit/c139d1721dba23dc1ef34f3a9eb33320ae0fb5af))
* **storybook:** adjust WS storybooks to match rolebinding endpoint ([3d2f01a](https://github.com/jjaquish/insights-rbac-ui/commit/3d2f01afa674e7e1f8e2a8656d4fb77258c7b77b))
* **storybook:** fix failing M3 workspace details test ([af00806](https://github.com/jjaquish/insights-rbac-ui/commit/af008068303d5b0e2a7decae5b94306dfd20fb9d))
* **storybook:** fix navigation test null console error ([4754e17](https://github.com/jjaquish/insights-rbac-ui/commit/4754e17a7078d4fccd4cc2308bae41e33439197b))
* **Storybook:** remove unsilence assertion ([fbce0c0](https://github.com/jjaquish/insights-rbac-ui/commit/fbce0c0cf79d720cb7d115a0c214bfa4c073deff))
* **storybook:** remove waitFor timeouts; fix failing tests ([ba6aeb6](https://github.com/jjaquish/insights-rbac-ui/commit/ba6aeb64fb564c9b00645f0d5d58778522669922))
* test-storybook must run on the same code used by chromatic-deployment ([2902d20](https://github.com/jjaquish/insights-rbac-ui/commit/2902d201a28466631736da5dc93c08d9a080c154))
* **test:** lint ([d95a966](https://github.com/jjaquish/insights-rbac-ui/commit/d95a966438bbaab1237df090cc95d4e88d625dc1))
* **tests:** correct Storybook play tests for confirmation modals ([9059b22](https://github.com/jjaquish/insights-rbac-ui/commit/9059b22888b00e48afb339a42667219da1cae56f))
* **tests:** fix console errors in storybook stories ([116813d](https://github.com/jjaquish/insights-rbac-ui/commit/116813deccabe6d317d5ac877ba2b67e0b51c45d))
* **tests:** update snapshots ([34a97ee](https://github.com/jjaquish/insights-rbac-ui/commit/34a97ee5034e0721e43c96012d0626fa8e3e7139))
* **test:** update snapshot ([dbe7c36](https://github.com/jjaquish/insights-rbac-ui/commit/dbe7c36b7bfac22b44c5cc1a6c03ff648740783f))
* **tiles:** permissions for tiles are fixed ([#1961](https://github.com/jjaquish/insights-rbac-ui/issues/1961)) ([531e3cd](https://github.com/jjaquish/insights-rbac-ui/commit/531e3cd00392e7daf6c63ae6b007dc9c2a76266c))
* **toolbar:** selection by using callback only ([#1885](https://github.com/jjaquish/insights-rbac-ui/issues/1885)) ([8905442](https://github.com/jjaquish/insights-rbac-ui/commit/890544286c772422854d608d58d3a3c33f64cfa1))
* tweak MUA mobile/tablet breakpoints ([1d30265](https://github.com/jjaquish/insights-rbac-ui/commit/1d30265e3c58e846d0184c51a5a7c1f4f29c9ec2))
* **types:** use casting to unknown and to request type instead of any ([df6859b](https://github.com/jjaquish/insights-rbac-ui/commit/df6859b6205d5f48fe9e81fd393ad6d7686acd45))
* update 'user management - invite user' text ([d8753aa](https://github.com/jjaquish/insights-rbac-ui/commit/d8753aa1011a8d188437a24fc1c04f9532f5be37))
* update background image path in overview component ([#1934](https://github.com/jjaquish/insights-rbac-ui/issues/1934)) ([42e576d](https://github.com/jjaquish/insights-rbac-ui/commit/42e576da03e208341cc67169b62d58cf169c4696))
* update iam.svg url ([#1898](https://github.com/jjaquish/insights-rbac-ui/issues/1898)) ([b8a49c4](https://github.com/jjaquish/insights-rbac-ui/commit/b8a49c42bb2c72bd66a4b6df39857b58a3978e7f))
* update snapshots; localize string ([24a5d42](https://github.com/jjaquish/insights-rbac-ui/commit/24a5d42bb235a1ddd9b3e13d486d6bd9abfbba75))
* update tests for TableView migration ([b0f17fe](https://github.com/jjaquish/insights-rbac-ui/commit/b0f17fe02ca924b6700fcc1590c78603bf8ba38b))
* upgrade utility classes to PF5 ([750a18a](https://github.com/jjaquish/insights-rbac-ui/commit/750a18a60cdeacbee029b70ff1e7920f7b83e8f3))
* use inline style when calling workspaces api ([#1845](https://github.com/jjaquish/insights-rbac-ui/issues/1845)) ([3cdae15](https://github.com/jjaquish/insights-rbac-ui/commit/3cdae15d1e51a476ee5bee1361ac78c191279857))
* use node lts ([772a3e4](https://github.com/jjaquish/insights-rbac-ui/commit/772a3e410d48342b595ce41388109f154579b834))
* **UserAccess:** make user access cards look selected ([#1727](https://github.com/jjaquish/insights-rbac-ui/issues/1727)) ([2e58c45](https://github.com/jjaquish/insights-rbac-ui/commit/2e58c458ec9d9e529a1c953a7f8b5b941871165e))
* workspace selector styling ([#1873](https://github.com/jjaquish/insights-rbac-ui/issues/1873)) ([eb491ca](https://github.com/jjaquish/insights-rbac-ui/commit/eb491ca5777e297022eee629f28a0dff84c5b3f2))
* **ws-detail:** do not use as any while going trough rolebinding response ([7372bbd](https://github.com/jjaquish/insights-rbac-ui/commit/7372bbdb67bc0f7be8cbff8157bd8e385fbc9910))
* **ws:** filter by showing children of found nodes ([#1882](https://github.com/jjaquish/insights-rbac-ui/issues/1882)) ([a4532a5](https://github.com/jjaquish/insights-rbac-ui/commit/a4532a5342e5446227fea983dcd317501d823bf8))
* **WS:** raise WS limit to 10k ([#1841](https://github.com/jjaquish/insights-rbac-ui/issues/1841)) ([c7f50d7](https://github.com/jjaquish/insights-rbac-ui/commit/c7f50d75d62b01a98d288a407993755059ac6502))


### Features

* **access-management:** complete feature implementation with V2 API gap documentation ([3adf5c8](https://github.com/jjaquish/insights-rbac-ui/commit/3adf5c8947ca1d4835c1bd868d78111a8e3a69d2))
* add create user group to user group list ([#1713](https://github.com/jjaquish/insights-rbac-ui/issues/1713)) ([6c4cd82](https://github.com/jjaquish/insights-rbac-ui/commit/6c4cd824ac893aaf9b367f3a78865e2da26f3e00))
* add cypress test Make user an org admin ([#1796](https://github.com/jjaquish/insights-rbac-ui/issues/1796)) ([4bf69cc](https://github.com/jjaquish/insights-rbac-ui/commit/4bf69ccfa5ce0f039f4484614dd6792bb60a0965))
* add detailed view to Workspaces ([#1682](https://github.com/jjaquish/insights-rbac-ui/issues/1682)) ([2f1efc1](https://github.com/jjaquish/insights-rbac-ui/commit/2f1efc1fdff0cdd77972b479d3d5a12ad300c204))
* add disabled edit access button to WS details drawer ([#1918](https://github.com/jjaquish/insights-rbac-ui/issues/1918)) ([8b59ac4](https://github.com/jjaquish/insights-rbac-ui/commit/8b59ac4666c993fbc35c7c7fb509f632eb03c68d))
* add disabled grant access button to WS details ([#1906](https://github.com/jjaquish/insights-rbac-ui/issues/1906)) ([b5772d4](https://github.com/jjaquish/insights-rbac-ui/commit/b5772d4c5a705e7a7ca9bbd5d545559c6138de97))
* add dropdown to make user an org admin workspaces ([#1771](https://github.com/jjaquish/insights-rbac-ui/issues/1771)) ([b73a7f2](https://github.com/jjaquish/insights-rbac-ui/commit/b73a7f2a3ba221cf8cf31b1b3848b0f1b9bf0f5b))
* add empty and leading states for Roles table ([#1750](https://github.com/jjaquish/insights-rbac-ui/issues/1750)) ([c0d3ef4](https://github.com/jjaquish/insights-rbac-ui/commit/c0d3ef4d3227308860de2b6f97aa67972900fd2a))
* add empty new edit role page ([#1795](https://github.com/jjaquish/insights-rbac-ui/issues/1795)) ([2276b4f](https://github.com/jjaquish/insights-rbac-ui/commit/2276b4f310a75aed91d3e4920b5ace273ff619ed))
* add empty state and loading state to Users & User Groups ([#1707](https://github.com/jjaquish/insights-rbac-ui/issues/1707)) ([92ea430](https://github.com/jjaquish/insights-rbac-ui/commit/92ea430d3c461f11fa2428588e687fde4cab55c4))
* add initial ws selector module ([c44a11e](https://github.com/jjaquish/insights-rbac-ui/commit/c44a11edbdfcbe1224c05d50c1e0139cf5d6e12a))
* add lightspeed rebrand ([#1989](https://github.com/jjaquish/insights-rbac-ui/issues/1989)) ([6ad3f96](https://github.com/jjaquish/insights-rbac-ui/commit/6ad3f968cd0d8d6a25e20db516237e5be90051af))
* add message and link to role binding detail ([#2013](https://github.com/jjaquish/insights-rbac-ui/issues/2013)) ([9b51ee5](https://github.com/jjaquish/insights-rbac-ui/commit/9b51ee5a1ac427dff93af3fa5dceb3788d2d7784))
* add workspaces to iam section of services dropdown ([#1833](https://github.com/jjaquish/insights-rbac-ui/issues/1833)) ([5dd5fd9](https://github.com/jjaquish/insights-rbac-ui/commit/5dd5fd98a023667e185587eefb2941281c94f98b))
* **build-tools:** migrate to build tools ([#1769](https://github.com/jjaquish/insights-rbac-ui/issues/1769)) ([cca1d2f](https://github.com/jjaquish/insights-rbac-ui/commit/cca1d2f8f1466217f91c5f66063fd8a6f7bbb92a))
* centralize the pagination clamping check and logic to TableView ([f25c366](https://github.com/jjaquish/insights-rbac-ui/commit/f25c366c4e23476efad62c0b61c3214897ec3896))
* **codeowners:** update codeowners to experience-ui ([#1773](https://github.com/jjaquish/insights-rbac-ui/issues/1773)) ([2cf1f08](https://github.com/jjaquish/insights-rbac-ui/commit/2cf1f08977d62af8c20459dcb5d4202eee19eaa3))
* **common auth model:** add dropdown to make user an org admin ([#1740](https://github.com/jjaquish/insights-rbac-ui/issues/1740)) ([ac1b0f6](https://github.com/jjaquish/insights-rbac-ui/commit/ac1b0f6fb6ed1a46c68a36177d231ade9b729a71))
* **common-auth-model:** add mocked requests ([#1695](https://github.com/jjaquish/insights-rbac-ui/issues/1695)) ([966361c](https://github.com/jjaquish/insights-rbac-ui/commit/966361cb70c7bf4784d549a05d46eb43f82dfe59))
* **common-auth:** add it api to invite and edit users ([#1718](https://github.com/jjaquish/insights-rbac-ui/issues/1718)) ([0ac978c](https://github.com/jjaquish/insights-rbac-ui/commit/0ac978c95903f6a1a79cd82899f15cc405e56089))
* **common-auth:** add multi-select and active toggle to Users Table ([#1764](https://github.com/jjaquish/insights-rbac-ui/issues/1764)) ([6ff9f18](https://github.com/jjaquish/insights-rbac-ui/commit/6ff9f18cc7eb5274f67db781b3c6c0d068c325fb))
* complete Redux removal ([1c42dc3](https://github.com/jjaquish/insights-rbac-ui/commit/1c42dc37f60eb4e0422d745f444a0536f3c894bd))
* **components:** add TableView component with type-safe API ([4fab761](https://github.com/jjaquish/insights-rbac-ui/commit/4fab7613c27923cf93798bd39d58489df4264912))
* comprehensive codebase modernization and tooling overhaul ([3d01173](https://github.com/jjaquish/insights-rbac-ui/commit/3d011734ada451fe0912b9e7ec396b97cacb60de))
* convert roles and users JS components to TypeScript with TableView migration ([c3f86a7](https://github.com/jjaquish/insights-rbac-ui/commit/c3f86a75e1cc7299f3ee7040a8b934afcb658a38))
* create add to user group modal ([0112379](https://github.com/jjaquish/insights-rbac-ui/commit/011237902147bd8f7c6e702bb58524016d353269))
* create delete user groups modal ([#1703](https://github.com/jjaquish/insights-rbac-ui/issues/1703)) ([ed28740](https://github.com/jjaquish/insights-rbac-ui/commit/ed2874000ab2e090d0244865ccafe58aed2a5252))
* create edit user group page ([#1732](https://github.com/jjaquish/insights-rbac-ui/issues/1732)) ([6ee38d3](https://github.com/jjaquish/insights-rbac-ui/commit/6ee38d35da0edbc97ab34126de3349db2421e7fc))
* create user details view ([53ccf7a](https://github.com/jjaquish/insights-rbac-ui/commit/53ccf7a6970e48ff7881a910c69370950a433899))
* create user group page ([#1770](https://github.com/jjaquish/insights-rbac-ui/issues/1770)) ([55f911e](https://github.com/jjaquish/insights-rbac-ui/commit/55f911e3870176d663594b432d66a0dbe84ef2e7))
* delete workspace disable when non empty ([2fdb4fe](https://github.com/jjaquish/insights-rbac-ui/commit/2fdb4fe54ddab5b99ccc62ac0dfb903efa34c748))
* **dev-proxy:** use dev proxy when running start ([#1923](https://github.com/jjaquish/insights-rbac-ui/issues/1923)) ([19fedeb](https://github.com/jjaquish/insights-rbac-ui/commit/19fedeb8954a0d674f6636ded7ed6c7ce211234d))
* **EditWorkspace:** add edit workspace modal ([#1783](https://github.com/jjaquish/insights-rbac-ui/issues/1783)) ([f7a46e4](https://github.com/jjaquish/insights-rbac-ui/commit/f7a46e4c4b1b0ef2d84c44caf247ada8af947009))
* **editworkspace:** add the edit workspace wizard to list view ([#1799](https://github.com/jjaquish/insights-rbac-ui/issues/1799)) ([d314f48](https://github.com/jjaquish/insights-rbac-ui/commit/d314f4828144bbc4eaad4973f4c69f2e407143e9))
* enable sorting and filtering for users table ([#1777](https://github.com/jjaquish/insights-rbac-ui/issues/1777)) ([70507bb](https://github.com/jjaquish/insights-rbac-ui/commit/70507bb8c57e4126ab361b6da8dd659649bf90ea))
* **GrantAccessWizard:** add roles selection step ([3f97b0f](https://github.com/jjaquish/insights-rbac-ui/commit/3f97b0f9a6393e12cd85326bc6b7b11fc9cad127))
* **grantaccesswizard:** add user groups selector ([#1992](https://github.com/jjaquish/insights-rbac-ui/issues/1992)) ([4fa514d](https://github.com/jjaquish/insights-rbac-ui/commit/4fa514d31ca9b90b90b3f68de68ea42301103db5))
* **grantaccesswizard:** create grant access wizard ([37f7d19](https://github.com/jjaquish/insights-rbac-ui/commit/37f7d19d1fd8c380ced10cfb2b6b3ad1c31ceba9))
* **GroupRoles:** migrate to TableView ([6df9fd7](https://github.com/jjaquish/insights-rbac-ui/commit/6df9fd7c033578b2fb56e753e6dcb17be7a549a0))
* **groups:** add confirmation modals for remove actions on roles and members ([#1994](https://github.com/jjaquish/insights-rbac-ui/issues/1994)) ([1b94e8a](https://github.com/jjaquish/insights-rbac-ui/commit/1b94e8a84549f155d10049bb550766d888b394bb))
* **GroupServiceAccounts:** migrate to TableView ([adced0c](https://github.com/jjaquish/insights-rbac-ui/commit/adced0c5b9fb72b45989e10d7bf3e3af98aa3152))
* **groups:** migrate Groups slice from Redux to React Query ([82c8537](https://github.com/jjaquish/insights-rbac-ui/commit/82c853725c8cedc6f2e087c6f937916c84c40e75))
* **Groups:** use TableView to simplify the code ([e9e3df7](https://github.com/jjaquish/insights-rbac-ui/commit/e9e3df74aa32b0641ff6b6bf502313600223ded6))
* implement comprehensive Storybook integration and component documentation ([1095985](https://github.com/jjaquish/insights-rbac-ui/commit/1095985f79154756ff312c004feb5d7c82e75e25))
* **invite-users:** add invite users modal via data driven forms ([#1706](https://github.com/jjaquish/insights-rbac-ui/issues/1706)) ([98cb047](https://github.com/jjaquish/insights-rbac-ui/commit/98cb047b14ff13885d7ce2ea3f92cdccd5a7df49))
* **konflux:** enablet unit tests on Konflux ([#1656](https://github.com/jjaquish/insights-rbac-ui/issues/1656)) ([527b4d8](https://github.com/jjaquish/insights-rbac-ui/commit/527b4d89273077820459004049fbd16b79e42d2b))
* **konflux:** introduce remote Konflux pipeline ([#1793](https://github.com/jjaquish/insights-rbac-ui/issues/1793)) ([b75e11b](https://github.com/jjaquish/insights-rbac-ui/commit/b75e11b20f51685b2f1c01514c90b8be8a5ac8ae))
* migrate DataView components to TableView with useTableState ([a1f33d5](https://github.com/jjaquish/insights-rbac-ui/commit/a1f33d586964018e0cb430d9c3d5b04274630172))
* migrate Roles slice from Redux to TanStack Query ([23f668d](https://github.com/jjaquish/insights-rbac-ui/commit/23f668df8970f870ef79a9a8f5ea5fd39ee3ddd7))
* **myuseraccess:** filter out out-of-scope bundles and apps for itless env ([#1867](https://github.com/jjaquish/insights-rbac-ui/issues/1867)) ([6d42875](https://github.com/jjaquish/insights-rbac-ui/commit/6d4287552d8c27c32e35a1e85232ff5a4b8f8981))
* **nav:** iam nav overhaul ([#1993](https://github.com/jjaquish/insights-rbac-ui/issues/1993)) ([4771166](https://github.com/jjaquish/insights-rbac-ui/commit/4771166cf61893e12df87340ad37944148e31bd2))
* prevent workspace movement to child nodes ([594fafa](https://github.com/jjaquish/insights-rbac-ui/commit/594fafa1af77948645614eafcc8b910c656211bc))
* programmatically enable redux devtools extension support ([b490e60](https://github.com/jjaquish/insights-rbac-ui/commit/b490e60214252da9cbc0e1aff7f33543d89096d1))
* **rbac:** add access-requests ([#754](https://github.com/jjaquish/insights-rbac-ui/issues/754)) ([7fa22b0](https://github.com/jjaquish/insights-rbac-ui/commit/7fa22b0bd7ee61f09e266e09ac2691b1f011fd2f))
* remove Redux from type definitions and error handling ([9ad29a3](https://github.com/jjaquish/insights-rbac-ui/commit/9ad29a3c0e1342f8632606968b2291773aa691aa))
* replace custom SVG icons with PatternFly icons in WorkspacesOverview ([#1913](https://github.com/jjaquish/insights-rbac-ui/issues/1913)) ([f50bbbb](https://github.com/jjaquish/insights-rbac-ui/commit/f50bbbb36321fcae5ed3dc460c78f7d53975f533))
* **role wizard:** include add role wizard to new role page ([18b0aab](https://github.com/jjaquish/insights-rbac-ui/commit/18b0aabc54effb0e6f158bb18e38ee50814f8e8b))
* **role-binding:** use new version of rbac client to support role binding ([aecbce9](https://github.com/jjaquish/insights-rbac-ui/commit/aecbce9c1c2dab4826d63b850aac62f7696f53b8))
* **Rolebindings:** add Role binding api ([#1914](https://github.com/jjaquish/insights-rbac-ui/issues/1914)) ([9d0d0b3](https://github.com/jjaquish/insights-rbac-ui/commit/9d0d0b31cd064bed1237e2046c603b4fd9381ff0))
* **role:** edit role feature ([f581690](https://github.com/jjaquish/insights-rbac-ui/commit/f581690bf451e22abf8f2e19f21bdb0180b95e7f)), closes [#1795](https://github.com/jjaquish/insights-rbac-ui/issues/1795) [#1812](https://github.com/jjaquish/insights-rbac-ui/issues/1812)
* **roles,users:** migrate Role.tsx and User.tsx from Redux to React Query ([c45e532](https://github.com/jjaquish/insights-rbac-ui/commit/c45e532109e00f66630d477dee02921017b9ff94))
* **rolesdrawer:** make roles clickable ([c60f075](https://github.com/jjaquish/insights-rbac-ui/commit/c60f0757fe57a9f8fbe90fe65fc76210662b630f))
* **roles:** migrate roles list to TypeScript and fix race condition ([a0bd3e1](https://github.com/jjaquish/insights-rbac-ui/commit/a0bd3e1c81958f0e1eb5aeb8b0f3b62cdd67cf28))
* **RolesTable:** add bulk Delete Roles button ([7985c1e](https://github.com/jjaquish/insights-rbac-ui/commit/7985c1ed304bc793218635294527ed5a2cf11f4a))
* **RolesTable:** add sorting and filtering ([0558e6e](https://github.com/jjaquish/insights-rbac-ui/commit/0558e6ef4908da00ff6bc0a3a8f07305003327cf))
* **rolestable:** delete roles modal ([#1696](https://github.com/jjaquish/insights-rbac-ui/issues/1696)) ([546a465](https://github.com/jjaquish/insights-rbac-ui/commit/546a465963ea395fdb9c776313687b464d92b816))
* run test-storybook against Chromatic's build ([f0838dc](https://github.com/jjaquish/insights-rbac-ui/commit/f0838dc4f22f2a59d82240d228952d0523c8e0d0))
* **search:** add org admin global search entry ([17d4811](https://github.com/jjaquish/insights-rbac-ui/commit/17d48111fa3fc49024208fa9dcda3d97318e91b2))
* **serviceaccountslist:** convert service-accounts-list to use DataViewTable ([db75a8d](https://github.com/jjaquish/insights-rbac-ui/commit/db75a8d808a24d84d4af8bb9d08e781dec11bcb8))
* show WS enable alert only if user can perform this action ([#1681](https://github.com/jjaquish/insights-rbac-ui/issues/1681)) ([b89b2d3](https://github.com/jjaquish/insights-rbac-ui/commit/b89b2d3467f34996a36e5bd1052688fa4f021648))
* **storybook:** add comprehensive tests for remaining JS container components ([6530aed](https://github.com/jjaquish/insights-rbac-ui/commit/6530aedf81ff11e5a3c4be0bb009dcb2df27ee8e))
* **storybook:** add feature gap tests for V2 Users/UserGroups and Roles ([18da917](https://github.com/jjaquish/insights-rbac-ui/commit/18da91744ea2b3c8fa34b6d37e7ef0f72d0415f3))
* **Storybook:** detect problematic console messages and flag them as test errors ([a79dcbb](https://github.com/jjaquish/insights-rbac-ui/commit/a79dcbb5d1a00d7fe1e5766a9684394af5d30331))
* **Storybook:** mocked E2E test ([f107580](https://github.com/jjaquish/insights-rbac-ui/commit/f107580e36901b3595c64f4041ab5dc6cf7f876e))
* **Storybook:** mocked E2E test for Kessel milestones ([bafc655](https://github.com/jjaquish/insights-rbac-ui/commit/bafc65554a4c18e0db40fae1318b20345a54829f))
* temporarily updated tooltip content for workspace naming guidelines ([#1880](https://github.com/jjaquish/insights-rbac-ui/issues/1880)) ([74c48d7](https://github.com/jjaquish/insights-rbac-ui/commit/74c48d7d536df2ba2d75dbdd708f2c37c38a34a1))
* update technology icon path ([#1912](https://github.com/jjaquish/insights-rbac-ui/issues/1912)) ([b9d14e2](https://github.com/jjaquish/insights-rbac-ui/commit/b9d14e24c9d9f76690ad0a621ab9aadd07066ce6))
* use new workspace selector in create workspace wizard ([#1862](https://github.com/jjaquish/insights-rbac-ui/issues/1862)) ([c3eeb71](https://github.com/jjaquish/insights-rbac-ui/commit/c3eeb7197189a51ff57a3bf970c8e01f36df9cf1))
* **usergroups:** add create usergroup button ([#1972](https://github.com/jjaquish/insights-rbac-ui/issues/1972)) ([0d6658b](https://github.com/jjaquish/insights-rbac-ui/commit/0d6658b12c37902eada9af4a923c3b8e187fde45))
* **UserGroupsTable:** migrate to TableView ([29a38b9](https://github.com/jjaquish/insights-rbac-ui/commit/29a38b909cdcba757aab954b90396c7e262be62d))
* **userstable:** add delete user modal ([814f7f1](https://github.com/jjaquish/insights-rbac-ui/commit/814f7f161c513f7fe3bfd95c4909f30e10c18f30))
* **UsersTable:** migrate to TableView ([1aa3cb0](https://github.com/jjaquish/insights-rbac-ui/commit/1aa3cb063dfd31f5a839eeab45c02dfb70940983))
* **users:** Unify users table ([#1900](https://github.com/jjaquish/insights-rbac-ui/issues/1900)) ([4e15933](https://github.com/jjaquish/insights-rbac-ui/commit/4e15933dba2b9ebe5870b3339bd817336351d0ec))
* **workspaceDetails:** should be hidden when platform.rbac.workspaces-list flag is on ([#1784](https://github.com/jjaquish/insights-rbac-ui/issues/1784)) ([5a68258](https://github.com/jjaquish/insights-rbac-ui/commit/5a68258a666d5f206c29f8bcbd705bd7a6b707a2))
* **workspaces:** add ability to delete workspace from list view ([d0256af](https://github.com/jjaquish/insights-rbac-ui/commit/d0256af541c9a067c29e5819c7ab66299706828c))
* **Workspaces:** add ability to delete workspaces on details page ([c969f0f](https://github.com/jjaquish/insights-rbac-ui/commit/c969f0f4086a26820af2e753fdfc55c6fcb595fc))
* **workspaces:** allow ungrouped ws to have inventory detail ([#1839](https://github.com/jjaquish/insights-rbac-ui/issues/1839)) ([d631ac0](https://github.com/jjaquish/insights-rbac-ui/commit/d631ac0b79c305429738b4e2f26ed13d718e5cec))
* **workspaces:** enable overview if feature flag enabled ([#1683](https://github.com/jjaquish/insights-rbac-ui/issues/1683)) ([59fa607](https://github.com/jjaquish/insights-rbac-ui/commit/59fa60744a0fe99304f4cda2795c0a2120036c49))
* **workspaces:** migrate Workspaces feature from Redux to React Query ([80543f7](https://github.com/jjaquish/insights-rbac-ui/commit/80543f7df9b86278d56447031baaeaf63c26b0f2))
* **workspaces:** redirect to inventory ws table ([#1836](https://github.com/jjaquish/insights-rbac-ui/issues/1836)) ([ce0d204](https://github.com/jjaquish/insights-rbac-ui/commit/ce0d204b5b20cfb87bba0e7e525b5d59de80917b))
* **workspacewizard:** disable ws parent select ([#1832](https://github.com/jjaquish/insights-rbac-ui/issues/1832)) ([a237733](https://github.com/jjaquish/insights-rbac-ui/commit/a23773346e8a6cd090512b56de0885e69d0f5fcf))
* **workspacewizard:** expose workspace wizard through fec ([#1794](https://github.com/jjaquish/insights-rbac-ui/issues/1794)) ([b61d172](https://github.com/jjaquish/insights-rbac-ui/commit/b61d1724fca00eae2af91bcc26728f3bd8c389fb))
* **WS:** add loading and empty state to workspace list table ([#1751](https://github.com/jjaquish/insights-rbac-ui/issues/1751)) ([b2e8f1d](https://github.com/jjaquish/insights-rbac-ui/commit/b2e8f1d7eade80b826dbf202b085e78c96a483fc))


### Reverts

* Revert "chore(deps): bump http-proxy-middleware from 2.0.6 to 2.0.9 ([#1814](https://github.com/jjaquish/insights-rbac-ui/issues/1814))" ([#1831](https://github.com/jjaquish/insights-rbac-ui/issues/1831)) ([daabcc3](https://github.com/jjaquish/insights-rbac-ui/commit/daabcc32b0a2db120703b7c8ea76e21e91941cde))
* Revert "Do not send username when creating service account ([#1559](https://github.com/jjaquish/insights-rbac-ui/issues/1559))" ([#1560](https://github.com/jjaquish/insights-rbac-ui/issues/1560)) ([a310c88](https://github.com/jjaquish/insights-rbac-ui/commit/a310c885ab44d063e378393b75f161aa04670704))
* Revert "feat: add empty new edit role page ([#1795](https://github.com/jjaquish/insights-rbac-ui/issues/1795))" ([#1812](https://github.com/jjaquish/insights-rbac-ui/issues/1812)) ([e86b412](https://github.com/jjaquish/insights-rbac-ui/commit/e86b412deca0c34c99e447e71de8fd255c41e23d))
* Revert "feat(groups): add confirmation modals for remove actions on roles and…" ([#1995](https://github.com/jjaquish/insights-rbac-ui/issues/1995)) ([33a6daf](https://github.com/jjaquish/insights-rbac-ui/commit/33a6daf9bcbe9f11b6fd02fbb09fb5f860020006))
* Revert "Revert "Do not send username when creating service account ([#1559](https://github.com/jjaquish/insights-rbac-ui/issues/1559))" ([#1560](https://github.com/jjaquish/insights-rbac-ui/issues/1560))" ([#1561](https://github.com/jjaquish/insights-rbac-ui/issues/1561)) ([38dc92f](https://github.com/jjaquish/insights-rbac-ui/commit/38dc92fea5c5cd4db8a3dd1cbfe90cce572656a1))
